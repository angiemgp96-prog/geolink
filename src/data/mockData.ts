...
export const INITIAL_MEDIA_ITEMS: MediaItem[] = [
  ...
  },
  {
    ...
    creatorId: 'creator_1',
    creatorHandle: 'angelina69',
    title: '🔥 Video Exclusivo Beach Session 4K (Edición Extendida)',
    description: 'Video completo de 15 minutos grabado en alta definición 4K en la playa. Incluye descarga directa inmediata.',
    type: 'video',
    price: 15.00,
    currency: 'USD',
  ...
  },
  {
    ...
    creatorId: 'creator_1',
    creatorHandle: 'angelina69',
    title: '📸 Set de Fotos Glamour & Fashion (35 Fotos HD)',
  ...
  },
  {
    ...
    description: 'Detrás de escena inédito de la sesión privada + acceso directo a chat de la creadora.',
    type: 'bundle',
    price: 24.99,
    currency: 'USD',
